...
import json
import torch
from convlab2.policy.vhus.diachat_DG_BiGRU.goal_generator import GoalGenerator
...
from convlab2.policy.vhus.diachat_DG_BiGRU.vhus import UserPolicyVHUSAbstract
from convlab2.policy.vhus.diachat_DG_BiGRU.util import padding
from convlab2.policy.vhus.diachat_DG_BiGRU.util import capital
