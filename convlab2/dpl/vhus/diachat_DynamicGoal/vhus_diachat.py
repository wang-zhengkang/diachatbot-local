...
import json
import torch
from convlab2.policy.vhus.diachat_DynamicGoal.goal_generator import GoalGenerator
...
from convlab2.policy.vhus.diachat_DynamicGoal.vhus import UserPolicyVHUSAbstract
from convlab2.policy.vhus.diachat_DynamicGoal.util import padding
from convlab2.policy.vhus.diachat_DynamicGoal.util import capital
    ...
    def __init__(self, load_from_zip=False):
        ...
        if load_from_zip:
            self.user.load_state_dict(torch.load(
                'convlab2/policy/vhus/diachat_DynamicGoal/save/all_data_simulator.mdl'))
