            ...
            if diags['agentRole'] == 'User':
                ...
                for diag in diags['annotation']:
                    ...
                    for slot_values in diag['slot_values']:
                        i = i + 1
                        slot_value = slot_values['slot'] + ' = ' + slot_values['value'] + ' ; '
...
write_file(os.path.join(cur_dir, 'data/sys'), sys_results)
write_file(os.path.join(cur_dir, 'data/user'), user_results)
