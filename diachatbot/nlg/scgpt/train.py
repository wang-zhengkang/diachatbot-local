...
def main():
    ...
    # Setup distant debugging if needed(设置远程调试VS code)
    ...
    # Setup CUDA, GPU & distributed training(设置CUDA、GPU和分布式培训)
    ...
    #                                             cache_dir=args.cache_dir if args.cache_dir else None)
    tokenizer = BertTokenizer.from_pretrained('we-gpt2/vocab.txt')
